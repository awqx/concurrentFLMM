...
Model-building will be demonstrated on synthetic data without a random slope. The procedure for generating the data can be found in `data-raw/1-cflmm.R`.

```{r}
dat <- read.csv("data/1-cflmm.csv")
```
